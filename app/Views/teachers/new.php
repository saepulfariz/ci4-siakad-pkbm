                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= ($error = validation_show_error('nik')) ? 'border-danger' : ((old('nik')) ? 'border-success' : ''); ?>" id="nik" name="nik" placeholder="" value="<?= old('nik'); ?>">
                            </div>
                            <?= ($error) ? '<div class="error text-danger mb-2" style="margin-top: -15px">' . $error . '</div>' : ''; ?>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= ($error = validation_show_error('education_name')) ? 'border-danger' : ((old('education_name')) ? 'border-success' : ''); ?>" id="education_name" name="education_name" placeholder="Education_name" value="<?= old('education_name'); ?>">
                            </div>
                            <?= ($error) ? '<div class="error text-danger mb-2" style="margin-top: -15px">' . $error . '</div>' : ''; ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= ($error = validation_show_error('education_major')) ? 'border-danger' : ((old('education_major')) ? 'border-success' : ''); ?>" id="education_major" name="education_major" placeholder="Education_major" value="<?= old('education_major'); ?>">
                            </div>
                            <?= ($error) ? '<div class="error text-danger mb-2" style="margin-top: -15px">' . $error . '</div>' : ''; ?>
                            ...
                            <div class="form-group">
                                ...
                                <div id="imagePreview">
                                    <img class="img-thumbnail d-block mb-2" width="100" src="<?= asset_url(); ?>uploads/teachers/teacher.png" alt="">
