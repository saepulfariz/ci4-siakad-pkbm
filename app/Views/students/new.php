                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= ($error = validation_show_error('parent_father')) ? 'border-danger' : ((old('parent_father')) ? 'border-success' : ''); ?>" id="parent_father" name="parent_father" placeholder="Parent father" value="<?= old('parent_father'); ?>">
                            </div>
                            <?= ($error) ? '<div class="error text-danger mb-2" style="margin-top: -15px">' . $error . '</div>' : ''; ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= ($error = validation_show_error('parent_mother')) ? 'border-danger' : ((old('parent_mother')) ? 'border-success' : ''); ?>" id="parent_mother" name="parent_mother" placeholder="Parent mother" value="<?= old('parent_mother'); ?>">
                            </div>
                            <?= ($error) ? '<div class="error text-danger mb-2" style="margin-top: -15px">' . $error . '</div>' : ''; ?>
