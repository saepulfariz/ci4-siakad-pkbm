...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">New Assignment</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="datetime-local" class="form-control <?= ($error = validation_show_error('deadline')) ? 'border-danger' : ((old('deadline')) ? 'border-success' : ''); ?>" id="deadline" name="deadline" placeholder="deadline" value="<?= old('deadline'); ?>">
                            </div>
                            <?= ($error) ? '<div class="error text-danger mb-2" style="margin-top: -15px">' . $error . '</div>' : ''; ?>
