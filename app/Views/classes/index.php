                    ...
                    <div class="card-body">
                        <table class="table w-100" id="table2">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th><?= temp_lang('classes.parent_id'); ?></th>
                                    <th><?= temp_lang('classes.name'); ?></th>
                                    <th><?= temp_lang('classes.teacher_id'); ?></th>
                                    <th><?= temp_lang('educations.education'); ?></th>
                                        ...
                                        <td>
                                            ...
                                            <?php if ($can_delete): ?>
                                                <form class="d-inline" action='<?= base_url($link . '/' . $class->id); ?>' method='post' enctype='multipart/form-data'>
                                                    ...
                                                    <button type='button' data-ket="<?= temp_lang('classes.delete_confirm'); ?>" onclick='confirmDelete(this)' class='btn btn-sm mb-2 btn-danger'><i class="fas fa-trash"></i></button>
                                                </form>
                                            <?php endif; ?>
