...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">New Notification</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control <?= ($error = validation_show_error('message')) ? 'border-danger' : ((old('message')) ? 'border-success' : ''); ?>" id="message" name="message" placeholder="Message"><?= old('message'); ?></textarea>
