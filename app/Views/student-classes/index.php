                                        ...
                                        <td>
                                            ...
                                            <?php if ($can_delete): ?>
                                                ...
                                                <form class="d-inline" action='<?= base_url($link . '/' . esc($class->id)); ?>' method='post' enctype='multipart/form-data'>
                                                    ...
                                                    <button type='button' data-ket="<?= temp_lang('student_classes.delete_confirm'); ?>" onclick='confirmDelete(this)' class='btn btn-sm mb-2 btn-danger'><i class="fas fa-trash"></i></button>
                                                </form>
                                            <?php endif; ?>
