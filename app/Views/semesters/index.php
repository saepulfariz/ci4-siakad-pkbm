    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                $can_create = auth()->user()->can('semesters.create');
                $can_edit = auth()->user()->can('semesters.edit');
                                        ...
                                        <td>
                                            ...
                                            <?php if ($can_delete): ?>
                                                ...
                                                <form class="d-inline" action='<?= base_url($link . '/' . esc($semester->id)); ?>' method='post' enctype='multipart/form-data'>
                                                    ...
                                                    <button type='button' data-ket="<?= temp_lang('semesters.delete_confirm'); ?>" onclick='confirmDelete(this)' class='btn btn-sm mb-2 btn-danger'><i class="fas fa-trash"></i></button>
                                                </form>
