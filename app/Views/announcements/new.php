                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control <?= ($error = validation_show_error('content')) ? 'border-danger' : ((old('content')) ? 'border-success' : ''); ?>" id="content" name="content" placeholder="Content"><?= old('content'); ?></textarea>
